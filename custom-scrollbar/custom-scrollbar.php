    ...
    <div class="example">
        <div id="main_content" style="height:90%;">
            <div class="parent">
                ...
                <div>- Well that's what it was, - said Ernst. -- Try to imagine it. It is almost as disgusting.</div>
                <div>A sorowful howl was heard from the loudspeaker. "HELP HELP I AM AFRAID HELP..," the auto-translater was writing.</div>
    ...
    <script type="text/javascript">
        var ssb = {
            ...
            onmouseup: function(e) {
                ...
                if (ssb.asd && document.releaseCapture)
                    ssb.asd.releaseCapture();
